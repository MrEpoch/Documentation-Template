---
title: Hlavička komponent
description: Komponent responzivní hlavičky se sidebarem.
---
...
export default function Header() {
  return (
    <header className={`w-full`}>
      <div className="max-w-container w-full py-4 flex items-center">
        <Link
...
1. **[Shadcn sheet](https://ui.shadcn.com/docs/components/sheet)**
